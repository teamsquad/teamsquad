...
--
-- Name: away_teams; Type: VIEW; Schema: public; Owner: sid
--
...
--
-- Name: home_teams; Type: VIEW; Schema: public; Owner: sid
--
...
ALTER TABLE ONLY competitions
    ADD CONSTRAINT competitions_season_id_key1 UNIQUE (season_id, slug);


--
-- Name: competitions_season_id_key2; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY competitions
    ADD CONSTRAINT competitions_season_id_key2 UNIQUE (season_id, "position");
...
--
-- Name: groups_stage_id_key1; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY groups
    ADD CONSTRAINT groups_stage_id_key1 UNIQUE (stage_id, slug);
...
--
-- Name: notices_organisation_id_key1; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY notices
    ADD CONSTRAINT notices_organisation_id_key1 UNIQUE (organisation_id, slug);
...
--
-- Name: pages_organisation_id_key1; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY pages
    ADD CONSTRAINT pages_organisation_id_key1 UNIQUE (organisation_id, slug);
...
--
-- Name: seasons_organisation_id_key1; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY seasons
    ADD CONSTRAINT seasons_organisation_id_key1 UNIQUE (organisation_id, slug);
...
ALTER TABLE ONLY stages
    ADD CONSTRAINT stages_competition_id_key1 UNIQUE (competition_id, slug);


--
-- Name: stages_competition_id_key2; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY stages
    ADD CONSTRAINT stages_competition_id_key2 UNIQUE (competition_id, "position");
...
--
-- Name: teams_organisation_id_key1; Type: CONSTRAINT; Schema: public; Owner: sid; Tablespace: 
--

ALTER TABLE ONLY teams
    ADD CONSTRAINT teams_organisation_id_key1 UNIQUE (organisation_id, slug);
